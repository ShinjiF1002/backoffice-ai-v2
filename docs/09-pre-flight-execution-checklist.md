...
| PFC-03  | Bedrock Geo CRIS 再 verify    | AI 管理者              | ⏸ Pending   | 0 / 6               | (TBD - Bedrock model card archive + Geo CRIS sandbox sustain test + data residency counsel sign-off) | TBD           | AI 管理者 + SRE + Compliance officer (data residency 解釈 sync) |
