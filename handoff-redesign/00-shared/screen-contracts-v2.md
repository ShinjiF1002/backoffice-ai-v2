...
> **remediation 画面拡張 (2026-05-30)**: 9 → **11** (W2b/P1-2: `/search`・`/inbox` = B ×2 → A×2/B×6/C×3、✓) → **14** (W2c/P1-3 ✓: 業務責任者面 3 画面 = A×3/B×8/C×3) → **15** (W3 C4 ✓: `/cases/new` 手動起票 = B → **A×3 / B×9 / C×3 = 15**)。新画面の画面契約は **remediation-roadmap §1b ledger + §3.2/§3.3** が SSOT。本 doc 冒頭の「9 画面」は historical baseline。
