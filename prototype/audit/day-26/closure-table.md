...
| 改版履歴 | v0.1 (2026-05-26): PR 0 closure commit で skeleton 作成、F-1〜F-10 全 row status=pending 初期化。v0.2 (2026-05-26): PR 1 Wave 1 完了で F-1 → closed。v0.3 (2026-05-26): PR 2 Wave 2 完了で F-2 + F-5 + F-7 → closed (Gate 1 採用 spec 通り、Open Q 3 件 resolved)。v0.4 (2026-05-26): PR 3 Wave 3 完了で F-3 + F-4 + F-10 → closed (EmptyState/ErrorState/LoadingState primitives + applicable/N/A matrix + AuditTrail 7-state column + 5 facet target (業務+結果)/Date defer + CSV Export + 2 failed event)、Defer 解除済 |
