...
- **branch `remediation/p1`** @ `1322785`、base = `cf8df94` (P0 含む、`remediation/p0-store-foundation` tip)。**全 9 commit** (Part A 統合 → W0 → W0 closure → P1-W4 → P1-1 → sync → P1-5 CORE → docs sync)。
- **完了 wave**:
