...
| 改版履歴        | v0.1 (2026-05-24): 初版作成 (Day 4)。v0.2 (2026-05-25): Day 5 整合化 update (SLO _SSOT 参照 / §3 手順承認 RACI (Proposal source = AI / R = Manual 管理者 = Queue owner) / §3.4 BOUNDARY review proposal mechanism / §4.3 Type A Demo simplify 注記 / §7.1 Matrix B 表現 rewrite / §9.7 新規 Boundary Review Proposal、Plan v1.3 final patch 反映) |
...
- 本番 SLO は `docs/_SSOT.md` SLO 仮値表を SSOT とし、本 doc では参照のみ (仮値はすべて `[仮説 / 要検証]` ラベル付き、将来 `docs/05-metrics-and-gates.md` Day 9 起稿時に移管予定)
