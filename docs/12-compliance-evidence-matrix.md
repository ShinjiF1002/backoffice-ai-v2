...
| 関連文書        | **DOC-CA-08 v2.3.2** (control mapping target), **DOC-DM-07 v1.6.2** (control mapping target), **DOC-TM-10 v0.1** (threat × control linkage), **DOC-SRE-11 v0.1** (incident notification SLA), **DOC-PFC-09 v0.1 PFC-02** (本 doc が input doc) |
...
| ------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | --------------------------------------------------------- | -------------------- | ------------- |
| **500.02**               | Cybersecurity program (risk-based、written program)                                                   | (organizational、本 doc + DOC-CA-08 + DOC-TM-10 + DOC-SRE-11 全体)                                                              | DOC-CA-08 v2.3.2 全体 / DOC-TM-10 全体 / DOC-SRE-11 全体                                                                                                                                                                                  | Document set                                 | Compliance officer review + counsel sign-off              | (TBD)                | ⏸ Draft       |
...
| **500.15**               | Encryption (in transit + at rest)                                                                     | KMS + Aurora encryption at rest + S3 SSE-KMS + TLS 1.2+ + KMS multi-Region key                                                | DOC-CA-08 §5.5 KMS multi-Region key / §12.4 cross-account encryption / DM-07 §10.2 KMS / Secret rotation                                                                                                                                  | KMS config + encryption settings             | AWS Config rule `s3-bucket-server-side-encryption-enabled` 等 | (TBD)                | ⏸ Draft       |
