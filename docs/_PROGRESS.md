...
| Day 8           | UI design language gate    | 03 の Stripe design token (色 / typography / spacing / shadow / anim) / Alert UI 3 適用範囲 spec / 04 の AI 日次分析 logic SSOT                                           | 🟡 pending                      |
...
| Stripe 風 design language 具体 token の Day 8 確定                                                                                 | 🟡 Day 8 で実行                  | Day 8          | §2.3 に acceptance criteria 記載済、field-level token は Day 8 の 03 で確定 (Plan v1.4.1 Fix 4 / v1.4.2 Rule 3-4)                                        |
| AiProposalPanel 過去 case Alert UI 仕様 (3 適用範囲)                                                                               | 🟡 Day 8 spec / Day 16-18 実装   | Day 8 / Day 18 | §2.3 に acceptance criteria 記載済、field-level spec は Day 8 の 03 で確定、Day 16-18 high-fi で実装 (Plan v1.4.1 Fix 4 / v1.4.2 Rule 3-4)               |
