...
```
┌────────────────────────────────────────────────────────────────────────┐
│ AWS us-east-1 (Virginia, primary) + us-west-2 (Oregon, DR) [introduced v1.4、current v1.7.2] │
│                                                                        │
│ Operational store:                                                     │
│   - Aurora PostgreSQL 16 Serverless v2 (Multi-AZ, Global DB to us-west-2) [introduced v1.4、current v1.7.2] │
