# Backoffice AI v2 — Cloud Architecture (Phase 1 hand-off Draft、v2.3.2 current lock)
...
| 版数            | v2.3.2 (P1 改版履歴 + Plan v1.7 done-mark sync + P2 batch `introduced/current` provenance label 統一)                                                                                                                                                                       |
