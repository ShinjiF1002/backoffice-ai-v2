...
| 版数            | v0.5                                                                                                                                                                                                                                                                                                          |
| ステータス      | Gate pass (P0 verify + P1 + **P1.5 (Review #1 closure) 完了** + **P2 (残り 6 画面 medium-fi) 完了** + Day 15 gate 4 criteria 全 pass)                                                                                                                                                                             |
...
| 改版履歴        | v0.1 (2026-06-02): Day 14 着手前起稿 (Plan B-lite v2.3、`~/.claude/plans/fuzzy-marinating-starfish.md` ref、A-D closure grep zero hit verify 済、Day 13 canonical hash `7766874`)。v0.2 (2026-06-02): P0 verify + P1 完了反映 (commit `f1af8db`、6 grep gate 全 zero hit、DOM smoke pass for `/cases/CASE-2026-0142`)。v0.3 (2026-06-02): **P1.5 (Review #1 closure) 完了反映** (Plan B-lite v2.6、6 commits `b54de9a` + `c882fd7` + `9da6fd4` + `51b84d4` + `09e867a` + `c2f9ace` [C6 final]、warning fix `c745a20`、Review #1 F-01〜F-06 全 6 件 closure、F-07〜F-12 Day 16-18 backlog 転記、8 grep gate 全 zero hit、DOM smoke 5 routes pass、console error 0)。v0.4 (2026-06-03): **P2 (残り 6 画面 medium-fi) 完了反映** (Plan B-lite v2.7、D1 commit `6bc664c` [Inbox/SendBackComment/AgentSettings/AuditTrail/KnowledgeBrowser PageFooter swap 5 file] + D2 commit `86b6b0b` [AuditTrail/Metrics/KnowledgeBrowser chip pattern + Metrics zebra removal 3 file] + D3 commit `10940e2` [inventory v0.4 + _PROGRESS update]、8 P1.5 grep gate 全 zero hit retain、chip pattern positive grep 3 file 各 1+ hit、DOM smoke 6 P2 routes 全 console error 0、matrix 全 6 P2 画面 ✓ 完了)。v0.5 (2026-06-03): **Day 15 gate sign-off** (screenshot commit `b673640`、9 route PNG export `prototype/screenshots/day-15-medium-fi/01-dashboard.png` ... `09-knowledge-browser.png`、1440 × 900、9 file all > 50KB、total 1.6MB、console error 0 × 9 routes、4 criteria 全 pass)                                                                                                                                                                                  |
...
| Inbox | ✓ (P2 D1) | ✓ | ✓ | ✓ | ✓ (P2 D1 PageFooter) | ✓ (Day 14 開始時から 0 hit) |
| CaseReview | ✓ (P1) | ✓ | ✓ | N/A | ✓ (P1) | ✓ + 🔧 spec gap 1+2+3 closure 済 |
| SendBackComment | ✓ (P2 D1) | ✓ | ✓ | N/A | ✓ (P2 D1 PageFooter) | ✓ |
| ProposalReview | ✓ (P1) | ✓ | ✓ | N/A | ✓ (P1) | ✓ |
| AgentSettings | ✓ (P2 D1) | ✓ | ✓ | N/A | ✓ (P2 D1 PageFooter) | ✓ |
| AuditTrail | ✓ (P2 D1+D2) | ✓ | ✓ | ✓ | ✓ (P2 D1 PageFooter) | ✓ |
| Metrics | ✓ (P2 D2) | ✓ | ✓ | N/A | ✓ (P1.5 C4 PageFooter) | ✓ (hex L226 + L469 → var(--color-success)/var(--color-alert)) |
| KnowledgeBrowser | ✓ (P2 D1+D2) | ✓ | ✓ | ✓ | ✓ (P2 D1 PageFooter) | ✓ |
