...
Automation Maturity 進化条件 (4 KPI multi-criteria gate) は DOC-MON-05 (Day 9 起稿予定) を SSOT、ai-operator 24 §3.2 継承 (`[仮説 / 要検証]`、Plan v1.3 final patch + `docs/_PROGRESS.md` §2.4 確定):
...
- DOC-MON-05 (Day 9 起稿予定): 4 KPI multi-criteria gate / 7 KPI / 9 KRI
