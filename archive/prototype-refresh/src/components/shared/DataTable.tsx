                  ...
                  return (
                    <Fragment key={id}>
                      <tr
                        ...
                        className={cn(
                          'relative border-b border-[var(--color-border)] hover:bg-[var(--color-panel-inset)] focus-within:bg-[var(--color-panel-inset)]',
                      ...
                      >
                        ...
                        {selection && (
                          <td className={cn('relative z-10 w-10', tdBase)}>
                            <input
                              type="checkbox"
                              aria-label={`${id} を選択`}
