...
| 改版履歴        | v0.1 (2026-06-02): Day 14 着手前起稿 (Plan B-lite v2.3、`~/.claude/plans/fuzzy-marinating-starfish.md` ref、A-D closure grep zero hit verify 済、Day 13 canonical hash `7766874`)                                                                                                                              |
...
| --- | --- | --- | --- | --- | --- | --- |
| AppShell | N/A | ✏️ | N/A | N/A | N/A | ✏️ |
| Sidebar | N/A | ✏️ | N/A | N/A | N/A | ✏️ |
| TopBar | N/A | ✏️ | N/A | N/A | N/A | ✏️ |
| Dashboard | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ (hex 1 hit, L351) |
| Inbox | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ |
| CaseReview | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ (+ 🔧 BusinessApprovalChip + RelatedRuleAlert) |
| SendBackComment | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ |
| ProposalReview | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ |
| AgentSettings | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ |
| AuditTrail | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ |
| Metrics | ✏️ | ✏️ | ✏️ | N/A | ✏️ | ✏️ (hex 2 hit, Sparkline/Recharts) |
| KnowledgeBrowser | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ | ✏️ |

Token baseline (Day 14 開始時、pre-flight 再計測):
- **hex literal**: 3 hit = Dashboard.tsx `#94a3b8` (L351、必ず token 化) + Metrics.tsx 2 hit (Sparkline/Recharts series color、CSS var first try / 不可なら allowlist)
