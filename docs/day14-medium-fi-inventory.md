...
| 版数            | v0.4                                                                                                                                                                                                                                                                                                          |
| ステータス      | Draft (P0 verify + P1 + **P1.5 (Review #1 closure) 完了** + **P2 (残り 6 画面 medium-fi) 完了**、Day 15 gate 進行中)                                                                                                                                                                                           |
